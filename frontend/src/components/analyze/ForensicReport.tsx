...
export const ForensicReport: React.FC<ForensicReportProps> = ({ result, onReset }) => {
  console.log("🎨 FORENSIC REPORT RECEIVED:", JSON.stringify(result, null, 2));
  console.log("📊 AI%:", result.aiPercentage, "Human%:", result.humanPercentage);
        ...
        <div className="flex flex-col items-center gap-1 mt-6">
          <div className="flex justify-center items-center gap-4">
            ...
            <div className="flex flex-col items-center">
               <span className="text-sm font-orbitron uppercase tracking-widest">Confidence: {(result.confidence || 0).toFixed(1)}%</span>
